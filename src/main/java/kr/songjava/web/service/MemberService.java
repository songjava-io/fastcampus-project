...
public class MemberService implements UserDetailsService {
	...
	public void saveSchedule(MemberSchedule memberSchedule) {
		MemberSchedule data = memberScheduleMapper.get(memberSchedule.getScheduleSeq());
		if (data == null) {
			memberScheduleMapper.save(memberSchedule);
		} else {
			memberScheduleMapper.update(memberSchedule);
		}
	}
	...
	public void deleteSchedule(int scheduleSeq) {
		memberScheduleMapper.delete(scheduleSeq);
	}
